...
return [
    ...
    'form' => [
        ...
        'helpers' => [
            'company_id'     => 'Leave blank if the approver applies to every company.',
            'division_id'    => 'Leave blank if the approver applies to every division within the selected company scope.',
