...
class UpdateTransferRequestRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'submission_status.required'       => __('form-transfer::filament/resources/transfer-request/validation.status_required'),
            'submission_status.enum'           => __('form-transfer::filament/resources/transfer-request/validation.status_invalid'),
            'approval_status.required'         => __('form-transfer::filament/resources/transfer-request/validation.status_required'),
            'approval_status.enum'             => __('form-transfer::filament/resources/transfer-request/validation.status_invalid'),
            'realization_status.required'      => __('form-transfer::filament/resources/transfer-request/validation.status_required'),
            'realization_status.enum'          => __('form-transfer::filament/resources/transfer-request/validation.status_invalid'),
        ];
    }
}
